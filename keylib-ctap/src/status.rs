...
impl From<keylib_crypto::CryptoError> for StatusCode {
    fn from(err: keylib_crypto::CryptoError) -> Self {
        match err {
            keylib_crypto::CryptoError::InvalidPublicKey => Self::InvalidParameter,
            keylib_crypto::CryptoError::InvalidPrivateKey => Self::InvalidParameter,
            keylib_crypto::CryptoError::InvalidSignature => Self::InvalidParameter,
            keylib_crypto::CryptoError::DecryptionFailed => Self::PinAuthInvalid,
            keylib_crypto::CryptoError::EncryptionFailed => Self::Other,
            keylib_crypto::CryptoError::InvalidKeyLength { .. } => Self::InvalidParameter,
            keylib_crypto::CryptoError::KeyAgreementFailed => Self::Other,
            keylib_crypto::CryptoError::InvalidCoseKey => Self::InvalidParameter,
        }
    }
}
...
mod tests {
    ...
    fn test_from_crypto_error() {
        let status: StatusCode = keylib_crypto::CryptoError::InvalidPublicKey.into();
        assert_eq!(status, StatusCode::InvalidParameter);

        let status: StatusCode = keylib_crypto::CryptoError::DecryptionFailed.into();
